...
-- (DISPOSITION completed; the live preflight chain was primary 429 ->
-- normalize EQUITY_MARKET_PRICE_PROVIDER_UNAVAILABLE -> real-time1 429 ->
-- finance15 200 -> select EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED). The live
-- evidence is under demo/dispatch-pair/evidence/live-concurrent.* and
-- live-serial.*.
