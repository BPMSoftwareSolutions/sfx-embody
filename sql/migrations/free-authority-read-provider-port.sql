-- Free `authority-read-provider` from the deleted resolver
...
DECLARE @ns nvarchar(400)=N'sidefx:capability:authority-read-provider';
DECLARE @port nvarchar(400)=N'authority-read-provider-port';
