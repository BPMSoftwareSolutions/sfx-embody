-- restore-request-capability-from-objective.sql
--
-- Restores the working execution wiring of capability 100695
-- (request-capability-from-objective), scenario execute-admitted-proposal
-- sv 91540, after the declare-invoke-scenario-on-existing-capability lane
-- re-declared the scenario. That re-declaration ran the existing UPDATE path
...
-- ALREADY_RESTORED and changes nothing. Default: ROLLBACK after readback.
-- Commit twin: restore-request-capability-from-objective.commit.sql.
SET NOCOUNT ON;
SET XACT_ABORT ON;
BEGIN TRANSACTION;
