...
-- Parameters name meaning, not encoding: @contract_id is the contract the authority conforms to,
-- @scenario_authority is the declaration payload. Replay is idempotent.
