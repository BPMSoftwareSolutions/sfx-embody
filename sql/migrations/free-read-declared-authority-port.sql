-- Free `read-declared-authority` from the deleted resolver
...
DECLARE @ns nvarchar(400)=N'sidefx:capability:read-declared-authority';
DECLARE @port nvarchar(400)=N'read-declared-authority-port';
