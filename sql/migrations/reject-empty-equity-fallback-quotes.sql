-- Reject empty native quotes before declaring an equity fallback resolved.
-- Shared JSON change and installer template repair; guard state is never altered.
SET NOCOUNT ON;
SET XACT_ABORT ON;
BEGIN TRANSACTION;
DECLARE @procedure nvarchar(max)=REPLACE(OBJECT_DEFINITION(OBJECT_ID(N'model.install_provider_binding_change')),CHAR(13),N'');
IF @procedure IS NULL OR HASHBYTES('SHA2_256',SUBSTRING(@procedure,CHARINDEX(N'@document',@procedure),LEN(@procedure))) NOT IN (0x67fb90b23b40a3acad2066156797b6744e003e984c1e38453e302c8aeefa2ef2,0xccddbd019c3c3c3b4a7c28560e9c171822ffd1722c757819af0c5abc5065432b) THROW 51002,'QUOTE_INSTALLER_CHANGED_REPREPARE',1;
GO
...
BEGIN
 ...
 SELECT TOP 1 @current_operations=JSON_QUERY(d.definition_json,'$.semantics.authority.operations')
 FROM analysis.v_selected_semantic_definition d
 WHERE d.estate_model_pk=@estate AND d.object_kind='EXECUTION_AUTHORITY' AND d.declared_id=@capability_id+N'.v1'
 ...
 JOIN analysis.v_selected_semantic_definition d ON d.semantic_object_definition_pk=pv.semantic_object_definition_pk AND d.estate_model_pk=@estate
 WHERE event.scenario_version_pk=@scenario_version;
 DECLARE @operation_total int=(SELECT COUNT(*) FROM #operations);
 IF @operation_total<5 THROW 51002,'EQUITY_WORKING_EXECUTION_DIVERGED',1;
...
DECLARE @estate bigint=(SELECT estate_model_pk FROM source.current_model WHERE singleton_id=1);
DECLARE @object bigint,@definition bigint,@digest binary(32),@transformation bigint,@version bigint;
SET @object=NULL; SET @definition=NULL; SET @transformation=NULL; SET @version=NULL;
IF NOT EXISTS (SELECT 1 FROM analysis.v_selected_semantic_definition WHERE estate_model_pk=@estate AND object_kind='TRANSFORMATION' AND declared_id=N'select-finance15-price-route' AND (definition_json=N'{"address":{"id":"select-finance15-price-route","kind":"TRANSFORMATION","namespace":"sidefx:capability:resolve-equity-market-price-evidence"},"format":"sidefx-semantic-definition.v1","semantics":{"id":"select-finance15-price-route","expression":{"op":"let","bindings":{"completed":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}}},"value":{"op":"if","when":{"op":"path","from":"completed","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"record":{"op":"path","from":"payload","path":"value.body.0"}},"value":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"record","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"record","path":"currency"},"observedPrice":{"op":"path","from":"record","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"record","path":"regularMarketTime"},"marketState":{"op":"path","from":"record","path":"marketState"},"exchange":{"op":"path","from":"record","path":"exchange"},"sourceAttribution":{"op":"path","from":"record","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance15-stock-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi\/yahoo-finance15"},"nativeShape":{"op":"literal","value":"body.0"}}}}}},"else":{"op":"path","from":"input","path":"effectLineage.0"}}}}}' OR JSON_QUERY(definition_json,'$.semantics.expression')=N'{"op":"let","bindings":{"completed":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}}},"value":{"op":"if","when":{"op":"path","from":"completed","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"record":{"op":"path","from":"payload","path":"value.body.0"}},"value":{"op":"let","bindings":{"candidate":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"record","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"record","path":"currency"},"observedPrice":{"op":"path","from":"record","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"record","path":"regularMarketTime"},"marketState":{"op":"path","from":"record","path":"marketState"},"exchange":{"op":"path","from":"record","path":"exchange"},"sourceAttribution":{"op":"path","from":"record","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance15-stock-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi/yahoo-finance15"},"nativeShape":{"op":"literal","value":"body.0"}}}}},"absent":{"op":"filter","from":{"op":"object-values","value":{"op":"path","from":"candidate","path":"payload"}},"as":"field","where":{"op":"if","when":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":null}},"then":{"op":"literal","value":true},"else":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":""}}}}},"value":{"op":"if","when":{"op":"equals","left":{"op":"length","value":{"op":"path","from":"absent","path":""}},"right":{"op":"literal","value":0}},"then":{"op":"path","from":"candidate","path":""},"else":{"op":"object","fields":{"contractId":{"op":"path","from":"candidate","path":"contractId"},"disposition":{"op":"literal","value":"NATIVE_MARKET_PRICE_TESTIMONY_REJECTED"},"reasonCode":{"op":"literal","value":"REQUIRED_NATIVE_FIELDS_ABSENT"},"absentFieldCount":{"op":"length","value":{"op":"path","from":"absent","path":""}},"providerTestimony":{"op":"path","from":"candidate","path":"providerTestimony"}}}}}},"else":{"op":"path","from":"input","path":"effectLineage.0"}}}')) THROW 51002,'QUOTE_ROUTE_CHANGED_REPREPARE',1;
EXEC model.put_semantic_definition 'TRANSFORMATION',N'sidefx:capability:resolve-equity-market-price-evidence',N'select-finance15-price-route',N'{"id":"select-finance15-price-route","expression":{"op":"let","bindings":{"completed":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}}},"value":{"op":"if","when":{"op":"path","from":"completed","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"record":{"op":"path","from":"payload","path":"value.body.0"}},"value":{"op":"let","bindings":{"candidate":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"record","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"record","path":"currency"},"observedPrice":{"op":"path","from":"record","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"record","path":"regularMarketTime"},"marketState":{"op":"path","from":"record","path":"marketState"},"exchange":{"op":"path","from":"record","path":"exchange"},"sourceAttribution":{"op":"path","from":"record","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance15-stock-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi/yahoo-finance15"},"nativeShape":{"op":"literal","value":"body.0"}}}}},"absent":{"op":"filter","from":{"op":"object-values","value":{"op":"path","from":"candidate","path":"payload"}},"as":"field","where":{"op":"if","when":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":null}},"then":{"op":"literal","value":true},"else":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":""}}}}},"value":{"op":"if","when":{"op":"equals","left":{"op":"length","value":{"op":"path","from":"absent","path":""}},"right":{"op":"literal","value":0}},"then":{"op":"path","from":"candidate","path":""},"else":{"op":"object","fields":{"contractId":{"op":"path","from":"candidate","path":"contractId"},"disposition":{"op":"literal","value":"NATIVE_MARKET_PRICE_TESTIMONY_REJECTED"},"reasonCode":{"op":"literal","value":"REQUIRED_NATIVE_FIELDS_ABSENT"},"absentFieldCount":{"op":"length","value":{"op":"path","from":"absent","path":""}},"providerTestimony":{"op":"path","from":"candidate","path":"providerTestimony"}}}}}},"else":{"op":"path","from":"input","path":"effectLineage.0"}}}}',@object OUTPUT,@definition OUTPUT,@digest OUTPUT;
SET @transformation=(SELECT transformation_pk FROM model.transformation WHERE semantic_object_pk=@object);
SET @version=(SELECT transformation_version_pk FROM model.transformation_version WHERE semantic_object_definition_pk=@definition);
IF @transformation IS NULL THROW 51002,'QUOTE_TRANSFORMATION_NOT_FOUND',1;
IF @version IS NULL BEGIN
 INSERT model.transformation_version(transformation_pk,semantic_object_pk,semantic_object_definition_pk,definition_digest,expression_profile,object_kind,_owner_definition_pk,_canonical_pointer) VALUES(@transformation,@object,@definition,@digest,'json-expression-tree.v1','TRANSFORMATION',@definition,N'');
 SET @version=SCOPE_IDENTITY();
 EXEC model.normalize_transformation_expression @version;
END;
SELECT 'quote_route' AS result_set,N'select-finance15-price-route' AS transformation_id,@version AS transformation_version_pk;

SET @object=NULL; SET @definition=NULL; SET @transformation=NULL; SET @version=NULL;
IF NOT EXISTS (SELECT 1 FROM analysis.v_selected_semantic_definition WHERE estate_model_pk=@estate AND object_kind='TRANSFORMATION' AND declared_id=N'select-equity-price-route' AND (definition_json=N'{"address":{"id":"select-equity-price-route","kind":"TRANSFORMATION","namespace":"sidefx:capability:resolve-equity-market-price-evidence"},"format":"sidefx-semantic-definition.v1","semantics":{"id":"select-equity-price-route","expression":{"op":"let","bindings":{"fallbackCompleted":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}},"prior":{"op":"path","from":"input","path":"effectLineage.0"}},"value":{"op":"if","when":{"op":"path","from":"fallbackCompleted","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"quote":{"op":"path","from":"payload","path":"value.quoteResponse.result.0"}},"value":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"quote","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"quote","path":"currency"},"observedPrice":{"op":"path","from":"quote","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"quote","path":"regularMarketTime"},"marketState":{"op":"path","from":"quote","path":"marketState"},"exchange":{"op":"path","from":"quote","path":"exchange"},"sourceAttribution":{"op":"path","from":"quote","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance-real-time1-market-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi/yahoo-finance-real-time1"},"nativeShape":{"op":"literal","value":"quoteResponse.result.0"}}}}}},"else":{"op":"path","from":"prior","path":""}}}}}' OR JSON_QUERY(definition_json,'$.semantics.expression')=N'{"op":"let","bindings":{"fallbackCompleted":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}},"prior":{"op":"path","from":"input","path":"effectLineage.0"}},"value":{"op":"if","when":{"op":"path","from":"fallbackCompleted","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"quote":{"op":"path","from":"payload","path":"value.quoteResponse.result.0"}},"value":{"op":"let","bindings":{"candidate":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"quote","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"quote","path":"currency"},"observedPrice":{"op":"path","from":"quote","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"quote","path":"regularMarketTime"},"marketState":{"op":"path","from":"quote","path":"marketState"},"exchange":{"op":"path","from":"quote","path":"exchange"},"sourceAttribution":{"op":"path","from":"quote","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance-real-time1-market-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi/yahoo-finance-real-time1"},"nativeShape":{"op":"literal","value":"quoteResponse.result.0"}}}}},"absent":{"op":"filter","from":{"op":"object-values","value":{"op":"path","from":"candidate","path":"payload"}},"as":"field","where":{"op":"if","when":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":null}},"then":{"op":"literal","value":true},"else":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":""}}}}},"value":{"op":"if","when":{"op":"equals","left":{"op":"length","value":{"op":"path","from":"absent","path":""}},"right":{"op":"literal","value":0}},"then":{"op":"path","from":"candidate","path":""},"else":{"op":"object","fields":{"contractId":{"op":"path","from":"candidate","path":"contractId"},"disposition":{"op":"literal","value":"NATIVE_MARKET_PRICE_TESTIMONY_REJECTED"},"reasonCode":{"op":"literal","value":"REQUIRED_NATIVE_FIELDS_ABSENT"},"absentFieldCount":{"op":"length","value":{"op":"path","from":"absent","path":""}},"providerTestimony":{"op":"path","from":"candidate","path":"providerTestimony"}}}}}},"else":{"op":"path","from":"prior","path":""}}}')) THROW 51002,'QUOTE_ROUTE_CHANGED_REPREPARE',1;
EXEC model.put_semantic_definition 'TRANSFORMATION',N'sidefx:capability:resolve-equity-market-price-evidence',N'select-equity-price-route',N'{"id":"select-equity-price-route","expression":{"op":"let","bindings":{"fallbackCompleted":{"op":"equals","left":{"op":"path","from":"input","path":"disposition"},"right":{"op":"literal","value":"completed"}},"prior":{"op":"path","from":"input","path":"effectLineage.0"}},"value":{"op":"if","when":{"op":"path","from":"fallbackCompleted","path":""},"then":{"op":"let","bindings":{"payload":{"op":"try-parse-json","value":{"op":"base64-decode-utf8","value":{"op":"path","from":"input","path":"responseBodyBytes"}}},"quote":{"op":"path","from":"payload","path":"value.quoteResponse.result.0"}},"value":{"op":"let","bindings":{"candidate":{"op":"object","fields":{"contractId":{"op":"literal","value":"equity-market-price-evidence.v1"},"disposition":{"op":"literal","value":"EQUITY_MARKET_PRICE_EVIDENCE_RESOLVED"},"payload":{"op":"object","fields":{"symbol":{"op":"path","from":"quote","path":"symbol"},"region":{"op":"path","from":"root","path":"payload.region"},"currency":{"op":"path","from":"quote","path":"currency"},"observedPrice":{"op":"path","from":"quote","path":"regularMarketPrice"},"observedMarketTime":{"op":"path","from":"quote","path":"regularMarketTime"},"marketState":{"op":"path","from":"quote","path":"marketState"},"exchange":{"op":"path","from":"quote","path":"exchange"},"sourceAttribution":{"op":"path","from":"quote","path":"quoteSourceName"}}},"providerTestimony":{"op":"object","fields":{"bindingId":{"op":"literal","value":"rapidapi-yahoo-finance-real-time1-market-quotes.v1"},"providerId":{"op":"literal","value":"rapidapi/yahoo-finance-real-time1"},"nativeShape":{"op":"literal","value":"quoteResponse.result.0"}}}}},"absent":{"op":"filter","from":{"op":"object-values","value":{"op":"path","from":"candidate","path":"payload"}},"as":"field","where":{"op":"if","when":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":null}},"then":{"op":"literal","value":true},"else":{"op":"equals","left":{"op":"path","from":"field","path":""},"right":{"op":"literal","value":""}}}}},"value":{"op":"if","when":{"op":"equals","left":{"op":"length","value":{"op":"path","from":"absent","path":""}},"right":{"op":"literal","value":0}},"then":{"op":"path","from":"candidate","path":""},"else":{"op":"object","fields":{"contractId":{"op":"path","from":"candidate","path":"contractId"},"disposition":{"op":"literal","value":"NATIVE_MARKET_PRICE_TESTIMONY_REJECTED"},"reasonCode":{"op":"literal","value":"REQUIRED_NATIVE_FIELDS_ABSENT"},"absentFieldCount":{"op":"length","value":{"op":"path","from":"absent","path":""}},"providerTestimony":{"op":"path","from":"candidate","path":"providerTestimony"}}}}}},"else":{"op":"path","from":"prior","path":""}}}}',@object OUTPUT,@definition OUTPUT,@digest OUTPUT;
SET @transformation=(SELECT transformation_pk FROM model.transformation WHERE semantic_object_pk=@object);
SET @version=(SELECT transformation_version_pk FROM model.transformation_version WHERE semantic_object_definition_pk=@definition);
IF @transformation IS NULL THROW 51002,'QUOTE_TRANSFORMATION_NOT_FOUND',1;
IF @version IS NULL BEGIN
 ...
 EXEC model.normalize_transformation_expression @version;
END;
SELECT 'quote_route' AS result_set,N'select-equity-price-route' AS transformation_id,@version AS transformation_version_pk;

COMMIT TRANSACTION;
-- Installed after rollback dry-run and two same-session live preflight cases.
