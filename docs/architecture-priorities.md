...
| 12 | Reader operations must execute under the invocation path's host bindings (`ReadQuery`), and a failed read must carry its cause (F13) | request filed: `docs/sda-change-request-reader-operation-host-bindings.md` |
